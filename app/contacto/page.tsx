              ...
              <div>
                ...
                <div className="p-5 bg-white/[0.025] border border-white/[0.08] rounded">
                  ...
                  <div className="flex flex-col gap-2 mb-4 pt-3 border-t border-white/[0.08]">
                    <a href="https://wa.me/525568047949" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[0.85rem] text-[#F0EAD6] hover:text-[#25D366] transition-colors">
